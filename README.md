...
Para un despliegue limpio y profesional, usa este comando (si ya tienes la carpeta, la borrará con permisos de superusuario y reinstalará de cero):

```bash
sudo rm -rf Agent-assist && git clone https://github.com/reset18/Agent-assist.git && cd Agent-assist && sudo bash setup.sh
```
